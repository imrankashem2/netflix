    ...
    <div class="container">
      ...
      <div class="col-md-3 col-sm-4 col-xs-6 sm-top-30">
        ...
        <div class="vfx_upcomming_detail">
          <h4 class="vfx_video_title"><?php echo e(Str::limit($series_data->series_name,20)); ?></h4>          
        </div>            
        </div>                  
      </div>
      </a>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/viavilab/public_html/videostreaming/resources/views/pages/series_by_language.blade.php ENDPATH**/ ?>