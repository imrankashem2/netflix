          ...
          <div class="b-language"> 
            <a href="<?php echo e(URL::to('genres/movies/'.$genres_data->genre_slug)); ?>">
              <div class="language_text_block">
                <h3 class="name"><?php echo e($genres_data->genre_name); ?></h3>              
              </div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/viavilab/public_html/videostreaming/resources/views/pages/movies_genres.blade.php ENDPATH**/ ?>