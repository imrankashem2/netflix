            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/terms_page'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/viavilab/public_html/videostreaming/resources/views/admin/pages/terms_page.blade.php ENDPATH**/ ?>