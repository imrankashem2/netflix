                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div class="radio radio-success form-check-inline"  style="margin-top: 8px;">
                          <input type="radio" id="inlineRadio1" value="1" name="download_enable" <?php if(isset($movie->download_enable) && $movie->download_enable==1): ?> <?php echo e('checked'); ?> <?php endif; ?>>
                          <label for="inlineRadio1"> <?php echo e(trans('words.active')); ?> </label>
                      </div>
                      <div class="radio form-check-inline" style="margin-top: 8px;">
                          <input type="radio" id="inlineRadio2" value="0" name="download_enable" <?php if(isset($movie->download_enable) && $movie->download_enable==0): ?> <?php echo e('checked'); ?> <?php endif; ?> <?php echo e(isset($movie->id) ? '' : 'checked'); ?>>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/viavilab/public_html/videostreaming/resources/views/admin/pages/addeditmovie.blade.php ENDPATH**/ ?>