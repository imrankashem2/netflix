        ...
        <div class="row">
          <div class="col-xs-12">            
            ...
            @else
                ...
                <div id="container">
                  <video id="v_player" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="none" width="640" height="450" poster="{{URL::to('upload/source/'.$tv_info->channel_thumb)}}" data-setup="{}">
                    <!-- video source -->
...
var viavi_player = videojs("v_player", { 
                ...
                "height": 265,
                sources: [
                        	{ src: '{{$tv_info->channel_url}}', type: 'application/x-mpegURL'}
                        ],
            });
</script>
@endif
...
@if($tv_info->channel_url_type=="youtube")  
 
<script src="{{ URL::asset('site_assets/video_player/plugins/videojs-youtube/Youtube.min.js') }}"></script>
<script>
var viavi_player = videojs("v_player", { 
                "controls": true, 
                "autoplay": true,
                ...
                techOrder:  ["youtube"],
                sources: [
                        	{ src: '{{$tv_info->channel_url}}', type: 'video/youtube'}
                        ],
            });
</script>
@endif
